    ...
    <section className='container-fluid py-4 mt-5 bg-light certificate' id="certificate">
        ...
        <div className="row align-items-center">
            ...
            <h1 className="p-large-xl text-900 text-main mb-3 mt-4">
                ...
                The Bootcamp was conducted on 17<sup>th</sup>-18<sup>th</sup> April 2024, and its duration spanned 4 Hours Bootcamp, ensuring participants had ample time to acquire the skills and knowledge necessary to excel in the field of Java Fullstack Development .
                </p>
            </div>
        </div>
    </section>
